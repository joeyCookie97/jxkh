  ...
  <div style="width: 100%">
    ...
    >
      ...
      <template v-slot:operation="text, record">
        <a-space><a-button style="padding:0" @click="targetClick(record, 'update')" type="link"
          >修改</a-button
        ><a-button style="padding:0" @click="targetClick(record, 'update')" type="link"
          >删除</a-button
        ></a-space>
      </template>
    </a-table>
        ...
        <a-row :gutter="24">
          ...
          <a-col :span="8">
            <a-form-model-item label="页面名称" prop="name">
              <a-input placeholder="页面名称" v-model="form.name" />
            </a-form-model-item>
          </a-col>

          <a-col :span="8">
            <a-form-model-item label="页面地址" prop="path">
              <a-input placeholder="页面地址"  v-model="form.path" />
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <a-form-model-item label="页面描述" prop="des">
              <a-input placeholder="页面描述" v-model="form.des" />
            </a-form-model-item>
          </a-col>

          <a-col :span="8">
            <a-form-model-item label="上级页面" prop="parent">
              <a-input placeholder="上级页面" v-model="form.parent"  />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
