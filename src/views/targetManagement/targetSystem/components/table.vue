  ...
  <div style="width: 100%">
    ...
    >
      ...
      >
        <a-row :gutter="24">
          <a-col :span="8">
            <a-form-model-item label="目录编号" prop="id">
          ...
          <a-col :span="8">
            <a-form-model-item label="目录名称" prop="title">
              <a-input v-model="form.title" />
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <a-form-model-item label="上级目录" prop="parent">
              <a-input v-model="form.parent" />
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <a-form-model-item label="目录总分" prop="score">
